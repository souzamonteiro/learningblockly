...
/**
 * This task wraps javascript_compressed.js into a UMD module.
 * @example import 'blockly/maiascript';
 */
function packageMaiaScript() {
  return packageGenerator('maiascript_compressed.js', 'maiascript.js', 'MaiaScript');
};

/**
 * This task wraps python_compressed.js into a UMD module.
 * @example import 'blockly/protugol';
 */
function packagePortugol() {
  return packageGenerator('portugol_compressed.js', 'portugol.js', 'Portugol');
};
