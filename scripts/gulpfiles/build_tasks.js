...
/**
 * This task builds the MaiaScript generator.
 *     portugol_compressed.js
 */
function buildMaiaScript() {
  return buildGenerator('maiascript', 'MaiaScript');
};

/**
 * This task builds the Portugol generator.
 *     portugol_compressed.js
 */
function buildPortugol() {
  return buildGenerator('portugol', 'Portugol');
};
